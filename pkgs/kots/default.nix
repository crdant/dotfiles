...
buildGoModule rec {
  ...
  src = fetchFromGitHub {
    ...
    repo = "kots";
    rev = "v${version}";
    sha256 = "sha256-3QcR1DEhJQpJisHYOn+zrq/fFgqTAViCVUDGy23GeZk=";
  };

  vendorHash = if isDarwin then 
      "sha256-UhjzFI5fzA7LRzmTMSEaemIa7d1zEdZIxH2uFgZ42S0="
    else
      "sha256-/lEpgS//imPhAgWRwH3cdatwvJdZVHS0vNbMpKbk2eI=";

...
buildGoModule rec {
  ...
  src = fetchFromGitHub {
    ...
    repo = "kots";
    rev = "v${version}";
    sha256 = "sha256-JV4Fn6r0VzfDsK8MSPzwtxrcjaosMjrPJOhooyxb1Rg=";
  };

  vendorHash = if isDarwin then 
      "sha256-66fbhw2qp7aao3TAo73qejwJhRVchpPUTmVhOLGt6XM="
    else
      "sha256-4TZ3t+vruXYygQOTAlxDsAmUZKOuGUw9xZ9Csoh3zmY=";

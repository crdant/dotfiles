...
buildGoModule rec {
  ...
  src = fetchFromGitHub {
    ...
    repo = "kots";
    rev = "v${version}";
    sha256 = "sha256-0XBRrBOZNzhfTc2DyxiHxa1x3ESU03oytxSLDH+q+00=";
  };

  vendorHash = if isDarwin then 
      "sha256-LcCDhs19VfvJAkE0LUxmSVIXKvsYWRgcaktjyTso1UA="
    else
      "sha256-jeg/R4z2kbvfDOD4W5qn/7DI+dG98Vl4b/5nXV5QEME=";

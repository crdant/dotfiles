...
buildGoModule rec {
  ...
  src = fetchFromGitHub {
    ...
    repo = "kots";
    rev = "v${version}";
    sha256 = "sha256-o1jTuOtGK+zQ9xF5EqwsUb5RYnA+pvZSurqWnvBjLV4=";
  };

  vendorHash = if isDarwin then 
      "sha256-L8LtnLBRnauQ5QDnc52+u4r/ng0BAjgp+9Tnk6Wlmdg="
    else
      "sha256-Z4uOoJRPB+ubEnnA+fgULUMQ98CPVhdkrZFT62LMa8Y=";

...
buildGoModule rec {
  ...
  src = fetchFromGitHub {
    ...
    repo = "kots";
    rev = "v${version}";
    sha256 = "sha256-sHbq9av1/br/HG4l10h7Y67v8qRAZTflgtazTrwKlco=";
  };


  vendorHash = lib.optionalString stdenv.isLinux  "sha256-1Up6f2LJxbEsvfiQfGHdo9smDupYSAnGgNdR+YBIpDQ=" + 

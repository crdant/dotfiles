...
buildGoModule rec {
  ...
  src = fetchFromGitHub {
    ...
    repo = "replicated";
    rev = "v${version}";
    sha256 = "sha256-dOV+3b2RDfK6lG1SasryqBhQCJwS9/IeFCT+p7giVYs=";
  };

  vendorHash = if isDarwin then
      "sha256-hBWSb36ZJPJiDyFJWbh+kxogK9Ac7+TyDPYmliPQX4g="
    else
      "sha256-KECdzx+z03v8HAPUY+8MJUFF4Sw4QAFWd75/cJxmU9A=";

...
buildGoModule rec {
  ...
  src = fetchFromGitHub {
    ...
    repo = "replicated";
    rev = "v${version}";
    sha256 = "sha256-gxDQQOQHtgMkUU/51WKn2pI0UHpfyzaXDco44UM/dHo=";
  };

  vendorHash = if isDarwin then
      "sha256-wRF2Pv5UYmEt09oyMy3Tu7RfLmEQfj0/FSA/8Quarg4="
    else
      "sha256-aSJo1AIOhXqZ+PJn+ADg2yGgThbf9enE/XCch/1nTMM=";
